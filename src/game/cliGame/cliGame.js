...
var askForNumber = function () {
    return new Promise(function (resolve) {
        rl.question('Enter a number (0 to exit): ', function (input) {
            ...
            if (num === 0) {
                ...
                numbers.push(num);
                console.log("You entered: ".concat(num));
...
var startGame = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                sum = numbers.reduce(function (acc, curr) { return acc + curr; }, 0);
                console.log("The sum of all numbers is: ".concat(sum));
                return [2 /*return*/];
        }
    });
}); };
